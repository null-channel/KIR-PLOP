...
import (
	...
	"github.com/null-channel/job-hunting/tree-operator/internal/controller"
...
func init() {
	...
	utilruntime.Must(treev1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "427f46ff.nullcloud.io",
	...
	if err = (&controller.TreeReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "Tree")
		os.Exit(1)
	}
